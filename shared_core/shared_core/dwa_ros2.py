...
class Config:
    ...
    def assignOdomCoords(self, msg: Odometry) -> None:
        ...
        distancetime_ros2.odom_callback(self)
...
class DWANode(Node):
    def __init__(self):
        ...
        self.counter = distancetime_ros2.StringMessageCounter()
        self.file_value = distancetime_ros2.start_rosbag()
        ...
        distancetime_ros2.goal_sphere(self.config)
    ...
    def timer_callback(self):
        ...
        if yici > 0:
            self.marker_pub.publish(distancetime_ros2.markers)
        ...
        if atGoal(self.config) == 1 or write == 1:
            if yici > 0:
                ...
                distancetime_ros2.save(elapsed_time, self.config.distance, self.counter.count_time, inputkey, args.param, "map")
